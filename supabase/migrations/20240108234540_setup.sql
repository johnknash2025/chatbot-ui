...
AS $$
DECLARE
  project_url TEXT := 'https://nizonmjfcuqawbncjevx.supabase.co';
  service_role_key TEXT := 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6Im5pem9ubWpmY3VxYXdibmNqZXZ4Iiwicm9sZSI6InNlcnZpY2Vfcm9sZSIsImlhdCI6MTc0NzAyODg5NiwiZXhwIjoyMDYyNjA0ODk2fQ.6vf5GTrAkETrP8DtIKAPg4gw_fEeeCQSEyPmt7ouvow'; -- full access needed for http request to storage
